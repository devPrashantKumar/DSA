...
public class PowXandN {
    ...
    public static double powXNOptimized2(double x, int n){
        double result=1.0;
        long nn = n;
        if(nn<0) nn = -1*nn;
        if(x==0 || x==1) return x;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Input 1 " + x1+", " + n1 + " Output : "+PowXandN.powXNOptimized2(x1,n1));
        System.out.println("---------------------------------------------");
        ...
        System.out.println("Input 1 " + x2+", " + n2 + " Output : "+PowXandN.powXNOptimized2(x2,n2));
        System.out.println("---------------------------------------------");
        ...
        System.out.println("Input 1 " + x3+", " + n3 + " Output : "+PowXandN.powXNOptimized2(x3,n3));
        System.out.println("---------------------------------------------");
