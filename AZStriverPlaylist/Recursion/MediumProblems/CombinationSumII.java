...
public class CombinationSumII {
    ...
    */
    ...
    public static List<List<Integer>> combinationSumApproach3(int[] candidates, int target) {
        List<List<Integer>> result = new ArrayList<>();
        List<Integer> combination = new ArrayList<>();
        Arrays.sort(candidates);
        generateCombinationApproach3(candidates,target,combination,0,-1,result);
        return result;
    }

    public static void generateCombinationApproach3(int[] candidates, int target,List<Integer> combination, int index,int lastSkipped,List<List<Integer>> result){
        if(target<0) return;
        if(index == candidates.length && target==0){
            result.add(new ArrayList<>(combination));
            return;
        ...
        generateCombinationApproach3(candidates, target, combination, index+1,candidates[index],result);
        if(lastSkipped!=candidates[index]){
            combination.add(candidates[index]);
            generateCombinationApproach3(candidates, target-candidates[index], combination, index+1,lastSkipped,result);
            combination.remove(combination.size()-1);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Output : "+CombinationSumII.combinationSum2(candidates1, target1));
        System.out.println("Output : "+CombinationSumII.combinationSumApproach2(candidates1, target1));
        System.out.println("Output : "+CombinationSumII.combinationSumApproach3(candidates1, target1));
        System.out.println("--------------------------------------------------------------------");
        ...
        System.out.println("Output : "+CombinationSumII.combinationSum2(candidates2, target2));
        System.out.println("Output : "+CombinationSumII.combinationSumApproach2(candidates2, target2));
        System.out.println("Output : "+CombinationSumII.combinationSumApproach3(candidates2, target2));
        System.out.println("--------------------------------------------------------------------");

        int[] candidates3 = {1,1,2};
        int target3 = 3;
        System.out.println("Input: " + Arrays.toString(candidates3)+" target: "+target3);
        System.out.println("Output : "+CombinationSumII.combinationSum(candidates3, target3));
        System.out.println("Output : "+CombinationSumII.combinationSum2(candidates3, target3));
        System.out.println("Output : "+CombinationSumII.combinationSumApproach2(candidates3, target3));
        System.out.println("Output : "+CombinationSumII.combinationSumApproach3(candidates3, target3));
