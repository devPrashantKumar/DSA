...
public class TopKFrequentElements {
    ...
    /*
     * Time Complexity :O(n + n log k + k log k) -> O(n log k)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Output : " + Arrays.toString(topKFrequent2(input1, k1)));
        ...
        System.out.println("Output : " + Arrays.toString(topKFrequent2(input2, k2)));
        ...
        System.out.println("Output : " + Arrays.toString(topKFrequent2(input3, k3)));
