...
public class LowestCommonAncestorOfABinaryTree {
    ...
    public static void rootToNodeBacktrackingUtil(BinaryTreeNode root, List<BinaryTreeNode> path,BinaryTreeNode p, BinaryTreeNode q, List<List<BinaryTreeNode>>paths) {
        if (root == null) return;
        path.add(root);
        if (root == p || root==q) {
