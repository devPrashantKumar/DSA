...
public class MinimumNumberOfPlatformRequiredForRailway {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Arrival : "+Arrays.toString(new int[]{900, 940, 950, 1100, 1500, 1800})+" Departure : "+Arrays.toString(new int[]{910, 1200, 1120, 1130, 1900, 2000}));
        System.out.println("Minimum Paltform Required : "+findPlatform(new int[]{900, 940, 950, 1100, 1500, 1800}, new int[]{910, 1200, 1120, 1130, 1900, 2000}));
        System.out.println("---------------------------------------------------------------------------------------");
        System.out.println("trains arrival and departure");
        System.out.println("Arrival : "+Arrays.toString(new int[]{900, 1100, 1235})+" Departure : "+Arrays.toString(new int[]{1000, 1200, 1240}));
        System.out.println("Minimum Paltform Required : "+findPlatform(new int[]{900, 1100, 1235}, new int[]{1000, 1200, 1240}));
        System.out.println("-------------------------------------------------------------------------------");
    }
}
