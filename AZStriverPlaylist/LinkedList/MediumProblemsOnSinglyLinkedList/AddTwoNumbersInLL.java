...
public class AddTwoNumbersInLL {
    ...
    public static SingleLinkedListNode<Integer> addTwoNumbersInLLUsingDummyNode(SingleLinkedListNode<Integer> head1, SingleLinkedListNode<Integer> head2){
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------------------------");
        System.out.println("---------------------------------------------------------");
        SingleLinkedListNode<Integer> head4 = AddTwoNumbersInLL.addTwoNumbersInLLUsingDummyNode(head1,head2);
