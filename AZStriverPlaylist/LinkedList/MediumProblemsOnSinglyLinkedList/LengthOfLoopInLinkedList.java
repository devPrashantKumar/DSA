...
public class LengthOfLoopInLinkedList {
    ...
    * Time Complexity : O(n)
    */
    public static <T> int lengthOfLoopInLL2(SingleLinkedListNode<T> head) {
        SingleLinkedListNode<T> tortoise = head;
        SingleLinkedListNode<T> hare = head;
        int len = 0;
        while (hare != null && hare.next != null) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("output : " + LengthOfLoopInLinkedList.lengthOfLoopInLL2(head));
        // SingleLinkedListUtility.printLinkedList(head);
        System.out.println("----------------------------------------------------------");
        ...
        System.out.println("output : " + LengthOfLoopInLinkedList.lengthOfLoopInLL2(head2));
        // SingleLinkedListUtility.printLinkedList(head);
        System.out.println("----------------------------------------------------------");
    }
}
